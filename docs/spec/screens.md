...
and reserving room for a hidden marker changes the tab geometry. Feed and
Leaderboard show a destination-shaped skeleton while their live projection
loads. After five seconds without fresh data, the skeleton gives way to the
